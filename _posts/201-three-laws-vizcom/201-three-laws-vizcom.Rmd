...
description: |
  The Three laws of visual communication for the quantitative scientist
author:
...
In quantitative sciences, effective visual communication follows three laws:

1.	Have a clear purpose
2.	Show the data clearly
3.	Make the message obvious

These three laws correspond to the three main ingredients of any quantitative work: purpose, data, and message. Getting these right leads to success; failing in any of them leads to overall failure. In the next subsections, we discuss each of these laws in turn. 
...
*	Minimize the viewer’s eye movement. Place elements that are to be compared close to each other. Prefer direct labelling over a legend. See also Figure 5.
